...
void navigateToDetailsScreen(BuildContext context) {
  ...
  // utilizei PageRouteBuilder para personalizar a transição entre as telas.
  Navigator.push(
    context,
    ...
    PageRouteBuilder(
      ...
      transitionsBuilder: (context, animation, secondaryAnimation, child) {
        ...
        var fadeAnimation = Tween(begin: 0.0, end: 1.0).animate(CurvedAnimation(
          parent: animation, 
          curve: Curves.easeInOut, //suaviza o efeito
        ));
        
        //aplica a animação de opacidade na tela de destino (child).
